...
- 첫 번째 픽셀1이 w1과 곱해져서 z_티셔츠에 더해집니다. 두 번째 픽셀2도 w2와 곱해져서 z_티셔츠에 더해집니다. 마지막 픽셀784도 w784와 곱해져 z_티셔츠에 절편 b를 더합니다. z_바지에 대해서도 동일한 계산 과정이 수행됩니다. 
...
- z_티셔츠, z_바지와 같이 10개의 클래스에 대해 선형 방정식을 모두 계산한 다음에는 소프트맥스 함수를 통과하여 각 클래스에 대한 확률을 얻을 수 있습니다. 
